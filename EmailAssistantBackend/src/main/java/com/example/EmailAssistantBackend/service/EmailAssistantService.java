package com.example.EmailAssistantBackend.service;
...
public class EmailAssistantService {
    ...
    private String buildPrompt(EmailRequest emailRequest) {
        ...
        prompt.append("Generate the professional email reply for the email content . Please don't generate a subject line ");
